					...
					<div class="row justify-content-center">
						...
						<div class="col-xl-6 col-lg-6 col-md-7">
							...
							<div class="registration">
                                <h2 class="registration-title mb-2">Selamat Datang</h2>
                                <p class="mb-2">
                                    Silakan login terlebih dahulu, agar bisa melakukan pemesanan tiket, download tiket dan juga download sertifikat.
                                </p>
								<div class="social-btns-list">
									<button class="social-login-btn" onclick="window.location.href='{{ url('auth/google') }}'">
